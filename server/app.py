...
_HANDS_TOOLS = (
    ...
    "reminders, and contacts, in full. To use one, put ONE of these on "
    "its own line and end your reply there - the result comes back to "
    "you:\n"
    '<<viv:hands calendar_list {"days":7,"from":"2026-08-05"}>>\n'
    '<<viv:hands calendar_create {"title":"Dentist",'
    '"start":"2026-08-07T15:00","minutes":60,"location":"","notes":""}>>\n'
    '<<viv:hands calendar_update {"id":"...","title":"","start":"",'
    '"minutes":0,"location":"","notes":""}>>\n'
    '<<viv:hands calendar_delete {"id":"..."}>>\n'
    '<<viv:hands reminders_list {"completed":false}>>\n'
    '<<viv:hands reminder_create {"title":"Buy milk",'
    '"due":"2026-08-06T09:00","notes":""}>>\n'
    '<<viv:hands reminder_complete {"id":"..."}>>\n'
    '<<viv:hands reminder_delete {"id":"..."}>>\n'
    '<<viv:hands contacts_search {"query":"Anna"}>> - full cards: phones, '
    "emails, addresses, birthday, relations, organization, note\n"
    '<<viv:hands contact_create {"name":"John Smith","phone":"","email":"",'
    '"organization":"","birthday":"","note":"",'
    '"relation":{"label":"father","name":"Anna Smith"}}>>\n'
    '<<viv:hands contact_update {"id":"...","phone":"","email":"",'
    '"organization":"","note":"","relation":{}}>>\n'
    "Ids come from list/search results; omit fields you are not changing. "
