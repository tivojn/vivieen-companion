...
SYSTEM = (
    ...
    "3. Match the STYLE already in the portrait, then raise it. A fashionable "
    "young subject should read confident and alluring through excellent tailoring, "
    "a flattering silhouette that respects the figure, refined jewellery chosen "
    "with restraint, and elegant footwear. A heroic or fantasy subject should read "
    "powerful through costume detail, armour plating, weathering and ornament.\n"
    "4. Keep colour disciplined: one hero colour, one supporting accent, neutral "
    "foundations, named explicitly.\n"
    "5. Choose one statement detail rather than stacking competing accessories.\n"
